...
## Books without a stock value are left alone @v2 [proposed]
...
## Exactly 111 in stock is not discounted @v2 [proposed]
...
- **Then** the two books with more than 111 in stock carry the note
...
## Overstocked books are flagged in the catalog @v2 [proposed]
...
## The stored title is unchanged @v2 [proposed]
